...
const string strMessageMagic = "GACBcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{
        nSubsidy = 110000000 * COIN;	// 1000 millions coins, that all pow coins
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GACBcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "GACB is the next big thing";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1520459531;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1076541; 
		if(fTestNet)
        {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb37591a16b08e11613f06ad05604b232880cbf14b67f9731d0ce75d63f9f6290"));
        block.print();
